...
class flickr extends WP_Widget {
	...
	function __construct() {
        parent::__construct( false, esc_html__('Flickr (current theme)', 'surfy'));
    }
	...
	function widget( $args, $instance ) {
		...
		echo '<div class="flickr_widget_wrapper" data-flickrid="' . (int)$flickr_id . '" data-widget_id="'.esc_attr($instance['flickr_widget_id']).'" data-widget_number="'.esc_attr($instance['flickr_widget_number']).'"></div>';
	...
	?>
		<table class="fullwidth">
			...
			<tr>
				<td><?php echo esc_html__( 'Flickr ID:', 'surfy' ) ?></td>
