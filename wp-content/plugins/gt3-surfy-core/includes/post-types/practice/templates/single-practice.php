                ...
                <?php
                    while ( have_posts() ):
                        ...
                        if (get_post_thumbnail_id(get_the_id())) {
                            ...
                            echo '<img src="'.esc_attr($post_img_url).'" class="gt3-single-practice_thumbnail" alt="' . get_the_title() . '">';
                        }
                    ...
                    endwhile;
                    the_content(esc_html__('Read more!', 'gt3_surfy_core'));
                    wp_reset_postdata();
                ?>
            </section>
...
?>
    <div class="wrapper_404 height_100percent pp_block">
        <div class="container text-center pp_container">
            <h1><?php echo esc_html__('Password Protected', 'gt3_surfy_core'); ?></h1>
            <h2><?php echo esc_html__('This content is password protected. Please enter your password below to continue.', 'gt3_surfy_core'); ?></h2>
            <?php the_content(); ?>
        </div>
    </div>
<?php 
