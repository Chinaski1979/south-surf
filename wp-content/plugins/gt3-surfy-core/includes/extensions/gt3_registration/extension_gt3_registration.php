        ...
        */
        ...
        public function add_gt3_registration() {
            ...
            $registration_option[] = array(
                        ...
                        'title'    => esc_html__( 'Enter your purchase code:', 'surfy' ),
            ...
            if (get_option( 'gt3_registration_status') == 'active') {
                $registration_option[] = array(
                        'id'       => 'gt3_auto_update',
                        'type'     => 'switch',
                        'title'    => esc_html__( 'Enable Auto-update', 'surfy' ),
                        'default'  => true,
                    );
            }
            ...
            $this->parent->sections[] = array(
                ...
                'title'  =>  __( 'Product Activation', 'surfycore' ),
                /*'desc'   => __( 'This is GT3 Registration', 'surfycore' ),*/
                'icon'   => 'el el-unlock',
        ...
        public function gt3__activation_refresh_on_autoupdate($transient){
            ...
            $redux_options = Redux::getOption( 'surfy', 'gt3_registration_id');
        ...
        public function gt3_first_init(){
            if (get_option('gt3_first_init') != 'true') { 
                $gt3_registration_id = Redux::getOption( 'surfy', 'gt3_registration_id'); 
                if (!empty($gt3_registration_id)) {
                ...
                if (!empty($registration_returns) && is_array($registration_returns)) {
                    if (!empty($registration_returns['Status_active']) && $registration_returns['Status_active'] == '1') {
                        ...
                        Redux::setOption( 'surfy', 'gt3_registration_id', $redux_options);
