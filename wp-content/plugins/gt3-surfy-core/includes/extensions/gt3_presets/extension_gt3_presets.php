        ...
        */
        ...
        public function add_preset_on_redux_save($options, $changed_values){
            ...
            $options_to_presets = array(
                ...
                'side_top__tablet_sticky',
                'side_top__tablet_background_sticky',
                'side_top__tablet_color_sticky',
                'side_top__tablet_height_sticky',
                'side_top__tablet_mobile',

                'side_middle__tablet_sticky',
                'side_middle__tablet_background_sticky',
                'side_middle__tablet_color_sticky',
                'side_middle__tablet_height_sticky',
                'side_middle__tablet_mobile',
                
                'side_bottom__tablet_sticky',
                'side_bottom__tablet_background_sticky',
                'side_bottom__tablet_color_sticky',
                'side_bottom__tablet_height_sticky',
                'side_bottom__tablet_mobile',
               
                'side_top__mobile_sticky',
                'side_top__mobile_background_sticky',
                'side_top__mobile_color_sticky',
                'side_top__mobile_height_sticky',
                'side_top__mobile_mobile',
                
                'side_middle__mobile_sticky',
                'side_middle__mobile_background_sticky',
                'side_middle__mobile_color_sticky',
                'side_middle__mobile_height_sticky',
                'side_middle__mobile_mobile',
               
                'side_bottom__mobile_sticky',
                'side_bottom__mobile_background_sticky',
                'side_bottom__mobile_color_sticky',
                'side_bottom__mobile_height_sticky',
                'side_bottom__mobile_mobile',
                'text1_editor',
                'text2_editor',
                'text3_editor',
                'text4_editor',
