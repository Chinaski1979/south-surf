...
if ($text_separator_custom_color == 'yes') {
	$separator_text_color = ' style="color:'.(strlen($text_separator_custom_color_value) ? $text_separator_custom_color_value : esc_attr(gt3_option("theme-custom-color"))).'"';
} else {
...
if ( '' !== $title && 'separator_no_text' !== $layout ) {
	...
	$content .= '<h4' . $separator_text_color . '>' . $title . '</h4>';
}
