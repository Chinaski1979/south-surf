<?php
	...
	if ($imagebox_title_size != '') {
		$imagebox_title_line = (int)$imagebox_title_size * 1.4;
		$imagebox_title_css = 'font-size: ' . (int)$imagebox_title_size . 'px; line-height: ' . (int)$imagebox_title_line . 'px; ';
	} else {
		$imagebox_title_css = ' ';
	}
	...
	if ($imagebox_content_size != '') {
		$imagebox_content_line = (int)$imagebox_content_size * 1.857;
		$imagebox_content_css = 'font-size: ' . (int)$imagebox_content_size . 'px; line-height: ' . (int)$imagebox_content_line . 'px; ';
	} else {
