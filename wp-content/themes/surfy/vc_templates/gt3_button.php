<?php
	...
	if ($btn_icon_type == 'image') {
		...
		if ($btn_img_width != '') {
			$btn_icon_content .= '<div class="btn_icon_container"><img src="' . esc_url(aq_resize($featured_image_url, $btn_img_width*2, '', true, true, true)) . '" alt="'. esc_attr__('Button icon', 'surfy') .'" style="width:' . esc_attr($btn_img_width) . 'px;" /></div>';
		} else {
			$btn_icon_content .= '<div class="btn_icon_container"><img src="' . esc_url($featured_image_url) . '" alt="'. esc_attr__('Button icon', 'surfy') .'" /></div>';
		}
