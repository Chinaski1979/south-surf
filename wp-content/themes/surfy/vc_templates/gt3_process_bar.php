<?php
	...
	if ($iconbox_title_size != '') {
		$iconbox_title_line = (int)$iconbox_title_size * 1.4;
		$iconbox_title_css = 'font-size: ' . (int)$iconbox_title_size . 'px; line-height: ' . (int)$iconbox_title_line . 'px; ';
	} else {
		$iconbox_title_css = ' ';
	}
	...
	if ($iconbox_content_size != '') {
		$iconbox_content_line = (int)$iconbox_content_size * 1.4;
		$iconbox_content_css = 'font-size: ' . (int)$iconbox_content_size . 'px; line-height: ' . (int)$iconbox_content_line . 'px; ';
	} else {
		$iconbox_content_css = ' ';
	}
