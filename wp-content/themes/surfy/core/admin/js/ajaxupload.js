        ...
        new AjaxUpload(clickedID, {
            ...
            onComplete: function(file, response) {
                ...
                if(response.search('Upload Error') > -1){
                    ...
                    var buildReturn = '<a href="'+response+'" class="uploaded-image admin_uploaded-image" target="_blank"><img class="hide option-image admin_option-image" id="image_'+clickedID+'" src="'+response+'" /></a>';
