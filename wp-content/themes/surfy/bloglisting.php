	...
	<div class="blog_post_preview format-<?php echo esc_attr($pf); ?>">
		<div class="item_wrapper">
			...
			<?php
				...
				echo '' . (strlen($post_descr) ? $post_descr : '') . '<div class="clear post_clear"></div><a href="'. esc_url(get_permalink()) .'" class="learn_more">'. esc_html__('Read More', 'surfy') .'</a><div class="post_info">';
				if ($show_share == "1") {
					echo '
					<div class="post_share">
						...
						<div class="share_wrap">
							<ul>
								<li><a target="_blank" href="'. esc_url('https://www.linkedin.com/shareArticle?mini=true&url='.get_permalink().'&title='.get_the_title().'&source='.get_bloginfo("name")) .'"><span class="fa fa-instagram"></span></a></li>
				...
				if (strlen($featured_image[0]) > 0) {
					echo '<li><a target="_blank" href="'. esc_url('https://pinterest.com/pin/create/button/?url='. get_permalink() .'&media='. $featured_image[0]) .'"><span class="fa fa-pinterest-p"></span></a></li>';
				}
				echo '
							</ul>
						</div>
